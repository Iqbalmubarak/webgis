  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <header class="header bg-black">
            ...
            <!--logo start-->
            <a href="index.php" class="logo"><b>WebGIS Local Transportation (25 1811523007 Muhammad Iqbal Mubarak)</b></a>
            <div class="top-menu">
                        ...
                        <div class="white-panel pns" style="height:510px">
                          ...
                          <div style="height:475px; overflow: scroll;  margin:20px;">
                            <div class="container2">
                              ...
                              <div class="row2">
                                <div class="column">
                                  <img class="demo cursor" src="foto/19-1.jpg" style="width:100%" onclick="currentSlide(1)">
                                </div>
                                <div class="column">
                                  <img class="demo cursor" src="foto/14-1.jpg" style="width:100%" onclick="currentSlide(2)">
                                </div>
                                <div class="column">
                                  <img class="demo cursor" src="foto/15-1.jpg" style="width:100%" onclick="currentSlide(3)">
                                </div>
                                <div class="column">
                                  <img class="demo cursor" src="foto/18-1.jpg" style="width:100%" onclick="currentSlide(4)">
                                </div>
                      ...
                      <div class="col-md-11 col-sm-12 mb">
                        <div class="white-panel pns" style="height: 310px">
                          <header class="panel-heading" style=" width: 100%"  >
                            <label class="btn btn-compose" style="background-color:black;border-colom: 1px solid black" id="judul_table" style="margin-bottom: 0px">Popular Transportation
                            </label>
                          </header>
                        ...
                        <div class="slideshow-container">
                              ...
                              <div class="mySlides fade">
                                ...
                                <img onclick="galeri('19')" src="../_foto/19-1.jpg" style="width:100%">
                                <div class="text">Popular 1</div>
                              </div>

                              <div class="mySlides fade">
                                <div class="numbertext">2 / 3</div>
                                <img onclick="galeri('14')" src="../_foto/14-1.jpg" style="width:100%">
                                <div class="text">Popular 2</div>
                              </div>
                              <div class="mySlides fade">
                                <div class="numbertext">3 / 3</div>
                                <img onclick="galeri('15')" src="../_foto/15-1.jpg" style="width:100%">
                                <div class="text">Popular 3</div>
                              </div>
                              <a class="prev" onclick="plusSlides(-1)">&#10094;</a>
                              <a class="next" onclick="plusSlides(1)">&#10095;</a>
                              </div>
                    ...
                    <div id="view_kanan_track" class="col-md-4 col-sm-4 mb" style="margin-top:20px;display:none">
                        <div class="white-panel pns">
                           ...
                           <div style="padding:20px" >                            
                            ...
                            <a role='button' class='btn btn-success text-center' style="margin-top:10px" onclick='reset_rute();' id='btnik'>Reset </a>
                           </div>
                        </div>
                      </div><!-- /col-md-12 --> 
                           ...
                           <div style="padding:20px" >                            
                             ...
                             <div class="row" style="margin:5px">
                               <div class="col-sm-5 col-xs-5">
                                  ...
                                  <a role='button' class='btn btn-success text-center' id='btnik' style="width: 100%;">Restaurant Position</a>
                                </div>
                               <div id="text_awal" class="col-sm-7 col-xs-7" style="font-size:12px;text-align:left">
                             ...
                             <div class="row" style="margin:5px">
                               <div class="col-sm-5 col-xs-5">
                                ...
                                <a role='button' class='btn btn-success text-center' onclick='posisi_manual_res_2();' id='btnik' style="width: 100%;">Position End </a>
                               </div>
                            ...
                            <a role='button' class='btn btn-success text-center' style="margin-top:10px" onclick='call_rute_2();' id='btnik'>Process </a>
                            <a role='button' class='btn btn-success text-center' style="margin-top:10px" onclick='reset_rute();' id='btnik'>Reset </a>
                           </div>
                        </div>
                      </div><!-- /col-md-12 -->   
