...
//        var server = "http://156.67.221.207/angkot_bkt/";
        var server = "http://localhost/tbiisi/";
      ...
      *********************************************************************************************************************************************************** */
      ...
      function menu_angkot_track_restaurant() { // KLIK MENU ANGKOT KIRI
          $("#view_table_restaurant").show();
          $('#table_kanan_restaurant_1').empty();
          $('#table_kanan_restaurant_1').append("<tr><th class='centered'>Restaurant Name</th><th class='centered'>Action</th></tr>");
            $.ajax({
                url: server+'/_data_restaurant.php', data: "", dataType: 'json', _success: function (rows) {
                    for (var i in rows) {
                        var row = rows[i];
                        var name = row.nama;
                        var id = row.id;
                        ...
                        map.setCenter(centerBaru);
                        $('#table_kanan_restaurant_1').append("<tr><td>" + name + "</td><td><a role='button' class='btn btn-success fa fa-info' style='margin-right:10px' onclick='recomendation_restaurant("+latitude+","+longitude+")'>Route</a></td></tr>");
      ...
      function recomendation_restaurant(latitude,longitude){
        $("#view_kanan_place").show();

        document.getElementById('input_posisi_awal_res_lat').value=latitude;
        document.getElementById('input_posisi_awal_res_lng').value=longitude;
        //POSISI MAP
        centerBaru = new google.maps.LatLng(latitude, longitude);
        map.setCenter(centerBaru);
        map.setZoom(16);
    ...
    //             $('#label_gallery').append("<a class='btn btn-success' role=button' data-toggle='collapse'  onclick='galeri(\""+id_angkots+"\")' title='Nearby' aria-controls='Nearby' id='btn_gallery'><i class='fa fa-compass' style='color:black;''></i><label>&nbsp Gallery</label></a>")
    ...
    function pilih_objek_sekitar_angkot(id_angkots){ // ANGKOT - KLIK TOMBOL RUTE - DATA 1 ANGKOT
        ...
        function multiple_list(){
            ...
            { 
                ...
                // Tombol Button Sekitar Angkot
                $('#list').empty();
                $('#list').append("<a role='button' class='btn btn-success text-center' onclick='selectMultiple(\""+id+"\")' id='btnik' style='margin:10px'>Process </a>");            
              } 
            });    
        }
        ...
        function listAngkot(){ // Menu Angkot - List Angkot
          ...
          { 
              for (var i in rows){ 
                ...
                var latitude=row.latitude;
                var longitude = row.longitude;
                $('#kanan_table').append("<tr><td>"+destination+"</td><td><a role='button' title='info' class='btn btn-success fa fa-info' onclick='data_angkot_1_rute(\""+id+"\")'></a>&nbsp<a role='button' class='btn btn-success fa fa-taxi' title='local transportation' onclick='data_angkot_2_rute(\""+id+"\")'></a></td></tr>");          
      ...
      function angkot_sekitar(latitude,longitude,rad){ // Menu Angkot - List Angkot
        ...
        { 
            ...
            for (var i in rows){ 
              ...
              $('#kanan_table').append("<tr><td>"+destination+"</td><td><a role='button' class='btn btn-success fa fa-info' onclick='data_angkot_1_rute(\""+id+"\")'>&nbsp&nbsp&nbspInfo</a></td></tr>");
            }               
        }});      
      }
          ...
          $.ajax({url: server+'_data_angkot_cari.php?tipe='+tipe+'&nilai='+y, data: "", dataType: 'json', success: function(rows){ 
            if(rows == null)
            {
              ...
              for (var i in rows){ 
                ...
                var color = row.color;
                var route_color = row.route_color;
                $('#kanan_table').append("<tr><td>"+destination+"</td><td><a role='button' title='info' class='btn btn-success fa fa-info' onclick='data_angkot_1_rute(\""+id+"\")'></a></td></tr>");  
      ...
      function td_hotel_angkot(id_angkot){ // HOTEL SEKITAR ANGKOT
        ...
        $.ajax({url: server+'/_angkot_hotel.php?id_angkot='+id_angkot, data: "", dataType: 'json', success: function(rows){ 
          for (var i in rows){ 
            ...
            markersDua.push(marker);
            map.setCenter(centerBaru);
            $('#table_kanan_hotel').append("<tr><td>"+name+"</td><td><a role='button' class='btn btn-success fa fa-map-marker' style='margin-right:10px' onclick='listgeom_hotel(\""+id+"\")' title='Posistion'></a><a role='button' class='btn btn-success fa fa-info' style='margin-right:10px' onclick='modal_hotel(\""+id+"\")' title='Detail'></a><a role='button' class='btn btn-success fa fa-male' style='margin-right:10px' onclick='route_angkot(\""+lat2+"\",\""+lng2+"\",\""+lat+"\",\""+lng+"\",\""+id_angkot+"\",\""+id+"\")' title=''Directions></a><a role='button' class='btn btn-success fa fa-taxi' onclick='data_angkot_2_rute(\""+id_angkot+"\")' title='Route'></a></td></tr>");
          }//end for
        }});//end ajax  
      }
      ...
      function td_industri_angkot(id_angkot){ // INDUSTRI SEKITAR ANGKOT
        ...
        $.ajax({url: server+'_angkot_small_industry.php?id_angkot='+id_angkot, data: "", dataType: 'json', success: function(rows){ 
          for (var i in rows){ 
            ...
            markersDua.push(marker);
            map.setCenter(centerBaru);
            $('#table_kanan_industry').append("<tr><td>"+name+"</td><td><a role='button' class='btn btn-success fa fa-map-marker' style='margin-right:10px' onclick='listgeom_industri(\""+id+"\")' title='Position'></a><a role='button' class='btn btn-success fa fa-info' style='margin-right:10px' onclick='modal_small_industry(\""+id+"\")' title='Detail'></a><a role='button' class='btn btn-success fa fa-male' style='margin-right:10px' onclick='route_angkot(\""+lat2+"\",\""+lon2+"\",\""+lat+"\",\""+lon+"\",\""+id_angkot+"\",\""+id+"\")' title='Directions'></a><a role='button' class='btn btn-success fa fa-taxi' onclick='data_angkot_2_rute(\""+id_angkot+"\")' title='Route'></a></td></tr>");
          }//end for
        }});//end ajax  
      }
      ...
      function td_kuliner_angkot(id_angkot){ //KULINER SEKITAR ANGKOT
        ...
        $.ajax({url: server+'/_angkot_culinary_place.php?id_angkot='+id_angkot, data: "", dataType: 'json', success: function(rows){ 
          for (var i in rows){ 
            ...
            $('#table_kanan_culinary').append("<tr><td>"+name+"</td><td><a role='button' class='btn btn-success fa fa-map-marker' style='margin-right:10px'  onclick='listgeom_kuliner(\""+id+"\")' title='Position'></a><a role='button' class='btn btn-success fa fa-info' style='margin-right:10px' onclick='modal_kuliner(\""+id+"\")' title='Detail'></a><a role='button' class='btn btn-success fa fa-male' style='margin-right:10px' onclick='route_angkot(\""+lat2+"\",\""+lon2+"\",\""+lat+"\",\""+lon+"\",\""+id_angkot+"\",\""+id+"\")' title='Route'></a><a role='button' class='btn btn-success fa fa-taxi' onclick='data_angkot_2_rute(\""+id_angkot+"\")'></a></td></tr>");
            }//end for
          }});//end ajax  
        }
      ...
      function td_masjid_angkot(id_angkot){ // MASJID SEKITAR ANGKOT
        ...
        $.ajax({url: server+'/_angkot_worship_place.php?id_angkot='+id_angkot, data: "", dataType: 'json', success: function(rows){ 
          for (var i in rows){ 
              ...
              $('#table_kanan_worship').append("<tr><td>"+name+"</td><td><a role='button' class='btn btn-success fa fa-map-marker' style='margin-right:10px'  onclick='listgeom_worship(\""+id+"\")' title='Position'></a><a role='button' class='btn btn-success fa fa-info' style='margin-right:10px' onclick='modal_masjid(\""+id+"\")' title='Detail'></a><a role='button' class='btn btn-success fa fa-male' style='margin-right:10px' onclick='route_angkot(\""+lat2+"\",\""+lon2+"\",\""+lat+"\",\""+lon+"\",\""+id_angkot+"\",\""+id+"\")' title='Directions'></a><a role='button' class='btn btn-success fa fa-taxi' onclick='data_angkot_2_rute(\""+id_angkot+"\")' title='Route'></a></td></tr>");
            }//end for
          }});//end ajax  
      }
      ...
      function td_oo_Angkot(id_angkot){ // OLEH-OLEH SEKITAR ANGKOT
        ...
        $.ajax({url: server+'/_angkot_souvenir.php?id_angkot='+id_angkot, data: "", dataType: 'json', success: function(rows){ 
          for (var i in rows){ 
              ...
              $('#table_kanan_souvenir').append("<tr><td>"+name+"</td><td><a role='button' class='btn btn-success fa fa-map-marker' style='margin-right:10px'  onclick='listgeom_oo(\""+id+"\")' title='Position'></a><a role='button' class='btn btn-success fa fa-info' style='margin-right:10px' onclick='modal_oo(\""+id+"\")' title='Detail'></a><a role='button' class='btn btn-success fa fa-male' style='margin-right:10px' onclick='route_angkot(\""+lat2+"\",\""+lon2+"\",\""+lat+"\",\""+lon+"\",\""+id_angkot+"\",\""+id+"\")' title='Directions'></a><a role='button' class='btn btn-success fa fa-taxi' onclick='data_angkot_2_rute(\""+id_angkot+"\")' title='Route'></a></td></tr>");
            }//end for
          }});//end ajax  
      }
      ...
      function td_tw_angkot(id_angkot){ // TOURISM SEKITAR ANGKOT
        ...
        $.ajax({url: server+'/_angkot_tourism.php?id_angkot='+id_angkot, data: "", dataType: 'json', success: function(rows){ 
          for (var i in rows){ 
              ...
              $('#table_kanan_tourism').append("<tr><td>"+name+"</td><td><a role='button' class='btn btn-success fa fa-map-marker' style='margin-right:10px'  onclick='listgeom_tourism(\""+id+"\")' title='Position'></a><a role='button' class='btn btn-success fa fa-info' style='margin-right:10px' onclick='modal_tw(\""+id+"\")' title='Detail'></a><a role='button' class='btn btn-success fa fa-male' style='margin-right:10px' onclick='route_angkot(\""+lat2+"\",\""+lon2+"\",\""+lat+"\",\""+lon+"\",\""+id_angkot+"\",\""+id+"\")' title='Directions'></a><a role='button' class='btn btn-success fa fa-taxi' onclick='data_angkot_2_rute(\""+id_angkot+"\")' title='Route'></a></td></tr>");
            }//end for
        }});//end ajax  
      }
      ...
      // TEMPAT WISATA SEKITAR ANGKOT
        ...
        $.ajax({url: server+'_angkot_restaurant.php?id_angkot='+id_angkot, data: "", dataType: 'json', success: function(rows){ 
          for (var i in rows){ 
              ...
              $('#table_kanan_restaurant').append("<tr><td>"+name+"</td><td><a role='button' class='btn btn-success fa fa-map-marker' style='margin-right:10px' onclick='listgeom_restaurant(\""+id+"\")' title='Position'></a><a role='button' class='btn btn-success fa fa-info' style='margin-right:10px' onclick='modal_restaurant(\""+id+"\")' title='Detail'></a><a role='button' class='btn btn-success fa fa-male' style='margin-right:10px' onclick='route_angkot(\""+lat2+"\",\""+lon2+"\",\""+lat+"\",\""+lon+"\",\""+id_angkot+"\",\""+id+"\")' title='Directions'></a><a role='button' class='btn btn-success fa fa-taxi' onclick='data_angkot_2_rute(\""+id_angkot+"\")' title='Route'></a></td></tr>");
            }//end for
        }});//end ajax  
      }
        ...
        if (lat1==""||lng1==""||lat2==""||lng2=="") {
          ...
          $.ajax({url: url_tujuan, data: "", dataType: 'json', success: function(rows){            
            ...
            for (var i in rows.data){ 
              ...
              console.log(rute);
              console.log(fungsi);
              $('#view_tracking_table').append("<tr><td>"+rute+"</td><td><a role='button' class='btn btn-success fa fa-info'  onclick=\"hapus_kecuali_landmark();"+fungsi+"\"><i class='fa fa-search' style='color:#fff'></i>Rute</a></td></tr>");                           
            }//end for
            if (rows.jumlah == 0) {
              $('#kanan_rute').empty();
...
//              var isi = row[i];
            ...
            console.log(rute);
            console.log(fungsi);
            $('#view_tracking_table').append("<tr><td>"+rute+"</td><td><a role='button' class='btn btn-success '  onclick=\"hapus_kecuali_landmark();"+fungsi+"\">Route</a></td></tr>");
...
{
  $('#tombol').empty();
  $('#tombol').append('<a class="btn btn-success" role="button" id="hidelegenda" data-toggle="tooltip" onclick="hideLegenda()" title="Hide Legend"><i class="fa fa-eye-slash" style="color:black;"></i></a>');
      ...
      function industri_sekitar(latitude,longitude,rad){ // INDUSTRI SEKITAR
        ...
        $.ajax({url: server+'_sekitar_small_industry.php?lat='+latitude+'&long='+longitude+'&rad='+rad, data: "", dataType: 'json', success: function(rows){ 
          for (var i in rows){ 
            ...
            markersDua.push(marker);
            map.setCenter(centerBaru);
            $('#view_industri_table').append("<tr><td>"+name+"</td><td><a role='button' style='margin-right:10px' class='btn btn-success fa fa-taxi' onclick='route_sekitar(\""+latitude+"\",\""+longitude+"\",\""+lat+"\",\""+lon+"\")'></a><a role='button' style='margin-right:10px' class='btn btn-success fa fa-info' onclick='modal_industri(\""+id+"\")'></a><a role='button' class='btn btn-success fa fa-map-marker' onclick='set_center(\""+lat+"\",\""+lon+"\",\""+name+"\")'></a></td></tr>");
          }//end for
        }});//end ajax  
      }
      ...
      function restaurant_sekitar(latitude,longitude,rad){ // TEMPAT WISATA SEKITAR ANGKOT
          ...
          $.ajax({url: server+'_sekitar_restaurant.php?lat='+latitude+'&long='+longitude+'&rad='+rad, data: "", dataType: 'json', success: function(rows){ 
            for (var i in rows){ 
              ...
              $('#view_hotel_table').append("<tr><td>"+name+"</td><td><a role='button' style='margin-right:10px' class='btn btn-success fa fa-taxi' onclick='route_sekitar(\""+latitude+"\",\""+longitude+"\",\""+lat+"\",\""+lon+"\")'></a><a role='button' style='margin-right:10px' class='btn btn-success fa fa-info' onclick='modal_restaurant(\""+id+"\")'></a><a role='button' class='btn btn-success fa fa-map-marker' onclick='set_center(\""+lat+"\",\""+lon+"\",\""+name+"\")'></a></td></tr>");
            }//end for
          }});//end ajax  
        }
