            ...
            $.ajax({
                url: server+'/_data_restaurant.php', data: "", dataType: 'json', _success: function (rows) {
                    for (var i in rows) {
                        ...
                        map.setCenter(centerBaru);
                        $('#table_kanan_restaurant_1').append("<tr><td>" + name + "</td><td><a role='button' class='btn btn-default fa fa-info' style='margin-right:10px' onclick='recomendation_restaurant("+latitude+","+longitude+")'>Route</a></td></tr>");
        ...
        function listAngkot(){ // Menu Angkot - List Angkot
          ...
          { 
              for (var i in rows){ 
                ...
                var latitude=row.latitude;
                var longitude = row.longitude;
                $('#kanan_table').append("<tr><td>"+destination+"</td><td><a role='button' class='btn btn-success fa fa-info' onclick='data_angkot_1_rute(\""+id+"\")'></a>&nbsp<a role='button' class='btn btn-success fa fa-taxi' onclick='data_angkot_2_rute(\""+id+"\")'></a></td></tr>");          
      ...
      function angkot_sekitar(latitude,longitude,rad){ // Menu Angkot - List Angkot
        ...
        { 
            ...
            for (var i in rows){ 
              ...
              $('#kanan_table').append("<tr><td>"+destination+"</td><td><a role='button' class='btn btn-default fa fa-info' onclick='data_angkot_1_rute(\""+id+"\")'>&nbsp&nbsp&nbspInfo</a></td></tr>");
            }               
        }});      
      }
